...
const InfoCard = () => {
  return (
    <section className="relative z-20 overflow-hidden bg-gradient-to-br from-orange-50 via-yellow-50 to-red-50 text-text-primary md:flex md:justify-between md:gap-12 max-w-7xl mx-auto rounded-2xl shadow-2xl">
